...
{
    public GreaterEqualState(@NotNull List<Token> tokens, @NotNull CursorPosition cursorPosition)
    {
    ...
    public State process(@NotNull Character character, @NotNull CursorPosition cursorPosition)
    {
        ...
        {
            return createToken(character, Type.LOGIC_GREATER_EQUAL, cursorPosition);
        }
        else
        {
