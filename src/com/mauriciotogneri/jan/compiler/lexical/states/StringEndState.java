...
{
    public StringEndState(@NotNull List<Token> tokens, @NotNull String lexeme, @NotNull CursorPosition cursorPosition)
    {
    ...
    public State process(@NotNull Character character, @NotNull CursorPosition cursorPosition)
    {
        ...
        {
            return createToken(character, Type.STRING, cursorPosition);
        }
        else
        {
